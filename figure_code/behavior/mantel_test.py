...
def mantel_test(x, y, rng, confound_x=None, n=1000):
    ...
    null_samples = [single_fit(x, y_sq, rng, confound_x=confound_x, precomputed_partial_x=precomputed_partial_x, shuffle=True)[-1] for _ in range(n-1)]
